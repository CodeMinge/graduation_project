 ...
 * 连接DBEncrypt数据库
 */
public class DBEncryptConnection {
	public static final String DRIVERNAME = "com.microsoft.sqlserver.jdbc.SQLServerDriver";

	public static final String DBURL = "jdbc:sqlserver://localhost:1433;DatabaseName=DBEncryption";
	...
	public String connectTen() {
		...
		while (!connectOnce().equals(ServerMessage.DBSUCCESS)) {
			count ++;
			if(count > DBEncryptConnection.CONNECTION_COUNT) {
				break;
			}
